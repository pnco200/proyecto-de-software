          ...
          <div class="card-body">
            <form @submit.prevent="login">
              ...
              <div class="d-flex justify-content align-items-center mb-3">
                  ...
                  <img class="m-3" @click="redirigirUsuario" src="../assets/googleLogoOficial.png" alt="Logo" />
              </div>
            </form>
            <span class="redirect-text" @click="redirigirRegistro">O haga click aqui para registrarse!</span>
          </div>
        </div>
      </div>
    </div>
